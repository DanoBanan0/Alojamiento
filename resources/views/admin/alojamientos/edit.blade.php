...
<div class="py-2 max-w-4xl mx-auto sm:px-6 lg:px-8">
    {{-- Header --}}
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-900">Editar Alojamiento</h2>
        <p class="mt-2 text-gray-600">Actualiza la información del alojamiento</p>
    </div>
    ...
    <form action="{{ route('admin.alojamientos.update', $alojamiento) }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        @csrf
        @method('PATCH')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre', $alojamiento->nombre) }}" 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" step="0.01" name="precio_por_noche" value="{{ old('precio_por_noche', $alojamiento->precio_por_noche) }}" 
        ...
        <div class="mb-6">
            ...
            <textarea name="descripcion" rows="4"
                ...
                required>{{ old('descripcion', $alojamiento->descripcion) }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="url" name="imagen_url" value="{{ old('imagen_url', $alojamiento->imagen_url) }}" 
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition duration-200"
            ...
            <div>
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="activo" value="1" {{ $alojamiento->activo ? 'checked' : '' }}
                    ...
                    {{-- Destacado --}}
                    <div class="flex items-center">
                        <input type="checkbox" name="destacado" value="1" {{ $alojamiento->destacado ? 'checked' : '' }}
                            class="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500 transform scale-125">
